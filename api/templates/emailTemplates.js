...
function getSubscriptionEventTemplate({ eventType, userName, planName, amount, currency, startDate, expiresDate, promoCode }) {
  ...
  switch (planName) {
    case 'Premium':
    case 'Премиум':
      planFeaturesHtml = `<li>Безлимитное количество досок</li><li>Безлимитное количество стикеров</li><li>Безлимитное количество заметок и комментариев</li><li>До 100 папок</li><li>Библиотека изображений</li><li>Экспорт в PNG (A4, A3, A2, A1)</li><li>Экспорт в HTML</li><li>Дублирование досок</li><li>Режим рисования</li>`;
      break;
    case 'Individual':
    case 'Индивидуальный':
      planFeaturesHtml = `<li>До 18 интерактивных досок</li><li>До 100 стикеров</li><li>До 100 заметок и комментариев</li><li>До 9 папок</li><li>Библиотека изображений</li><li>Экспорт в PNG (A4, A3, A2, A1)</li><li>Экспорт в HTML</li><li>Дублирование досок</li><li>Режим рисования</li>`;
      break;
    case 'Demo':
    case 'Демо':
      planFeaturesHtml = `<li>Безлимитное количество досок</li><li>Безлимитное количество стикеров</li><li>Безлимитное количество заметок и комментариев</li><li>До 30 папок</li><li>Библиотека изображений</li><li>Экспорт в PNG (A4, A3, A2, A1)</li><li>Экспорт в HTML</li><li>Режим рисования</li>`;
      break;
    default:
