...
**Когда начинается cooldown:**
- При **подаче заявки** — cooldown начинается с момента отправки
- При **отклонении заявки** — cooldown обновляется и начинается с момента отклонения администратором

Это означает, что если заявка была на модерации 2 дня, а затем отклонена, пользователь должен ждать ещё 24 часа с момента отклонения.
