...
| Дата | Изменение |
|------|-----------|
| 2025-02-03 | Убрано ограничение по тарифам (`plan_id IN (6, 7)`) в `boardPartners.js`. Теперь все верифицированные пользователи отображаются в списке партнёров независимо от тарифного плана. |
| 2025-02-03 | Убрано ограничение по тарифам (`plan_id IN (6, 7)`) в счётчике партнёров (`discussion.js`). |
