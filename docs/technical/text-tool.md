...
6. В режиме превью можно:
   - **Перетащить текст** — зажать и тянуть в любом месте рамки (кроме угловых маркеров). Если поле ввода в фокусе — сначала кликните вне текста, чтобы снять фокус
...
- Логика: если поле ввода в фокусе и кликнули на него — редактирование; иначе — перемещение
...
- Добавлен `cursor: move` для input когда он не в фокусе
