...
const templateData = {
  cards: [
    { id: '1', x: 100, y: 200, width: 418, height: 280 },
    { id: '2', x: 150, y: 500, width: 418, height: 280 },
    { id: '3', x: 200, y: 800, width: 418, height: 280 }
  ]
}

const offset = calculateTemplateOffset(templateData.cards)
// { dx: -55, dy: -488 } - смещение для позиционирования в viewport

// Применение смещения к каждой карточке
...
### 2026-01-17: Создание модуля viewport.js
