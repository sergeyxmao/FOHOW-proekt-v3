...
Мы активировали для вас *14‑дневный демо‑доступ* с полным набором премиум‑функций.
...
const emailTemplates = [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'list', title: '🚀 Ваши возможности:', items: ['До 18 интерактивных досок', 'До 100 стикеров', 'До 100 заметок и комментариев', 'До 9 папок', 'Библиотека изображений', 'Скачать доску (структуру) как изображение (в формате A4, A3)', 'Поделиться доской (структурой) как веб‑страницей', 'Дублирование досок', 'Режим рисования'] },
      { type: 'button', text: '👤 В профиль' },
      { type: 'button', text: '📢 MarketingFohow' }
    ]
  },
