...
const emailTemplates = [
  {
    ...
    sections: [
      ...
      { type: 'list', title: '✨ Что вы получаете:', items: ['Безлимитные доски', 'Безлимитное количество лицензий на одной доске', 'Безлимитное количество заметок на одной доске', 'Безлимитное количество стикеров на одной доске', 'Безлимитные комментарии', 'Библиотеку изображений с возможностью создать свою собственную библиотеку', 'Экспорт в PNG (A4, A3, A2, A1)', 'Экспорт в HTML', 'Дублирование досок', 'Режим рисования'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'list', title: '✅ Что сейчас доступно:', items: ['До 3‑х досок', 'До 10 стикеров', 'До 10 заметок и комментариев', 'Экспорт в PNG (A4)'] },
  ...
  },
  {
    ...
    sections: [
      ...
      { type: 'list', title: '🚀 Ваши возможности:', items: ['Безлимитное количество досок', 'Безлимитное количество стикеров', 'Безлимитное количество заметок и комментариев', 'До 30 папок', 'Библиотека изображений', 'Экспорт в PNG (A4, A3, A2, A1)', 'Экспорт в HTML', 'Дублирование досок', 'Режим рисования'] },
      { type: 'button', text: '👤 В профиль' },
      { type: 'button', text: '📢 MarketingFohow' }
    ]
  },
  {
    ...
    sections: [
      ...
      { type: 'list', title: '🚀 Ваши возможности:', items: ['До 9 интерактивных досок', 'До 100 стикеров', 'До 100 заметок и комментариев', 'До 3 папок', 'Библиотека изображений', 'Экспорт в PNG (A4, A3, A2, A1)', 'Экспорт в HTML', 'Дублирование досок', 'Режим рисования'] },
      { type: 'button', text: '👤 В профиль' },
      { type: 'button', text: '📢 MarketingFohow' }
    ]
  },
