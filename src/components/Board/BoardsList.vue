...
<!-- Critical layout styles without scoped for dynamic import compatibility -->
<style>
.boards-page {
...
.boards-page .folders-list {
  flex: 1;
  padding: 16px 0;
  overflow-y: auto;
}

.boards-page .folder-item {
  display: flex !important;
  align-items: center !important;
  gap: 12px !important;
  padding: 12px 24px;
...
.boards-page .boards-list {
  display: grid !important;
  grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)) !important;
  gap: 20px !important;
}

.boards-page .board-card {
  background: white;
  border-radius: 12px;
  overflow: hidden;
  cursor: pointer;
...
.boards-page .board-thumb-image {
  width: 100%;
  height: 180px;
  object-fit: cover;
}

.boards-page .board-info {
  padding: 20px;
}

.boards-page .board-stats {
  display: flex !important;
  gap: 12px !important;
  flex-wrap: wrap;
}
