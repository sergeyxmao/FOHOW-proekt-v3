...
const getExportHtmlCss = () => `
  ...
  #canvas .card{position:absolute;display:flex;flex-direction:column;align-items:stretch;box-sizing:border-box;border-radius:14px;box-shadow:0 18px 32px rgba(47,128,237,0.12);overflow:visible;background:var(--card-shell-background,var(--card-fill,#ffffff));color:#111827;transition:transform .15s ease,box-shadow .15s ease;border:var(--card-border,1px solid var(--card-border-color,rgba(47,128,237,0.25)));touch-action:none;} #canvas .card.card--gold{box-shadow:0 18px 32px rgba(209,173,68,0.28);} #canvas .card.card--gold:hover{box-shadow:0 24px 40px rgba(209,173,68,0.32);}  #canvas .card-header{position:relative;height:52px;border-radius:16px 16px 0 0;display:flex;align-items:center;justify-content:center;text-align:center;padding:10px 44px;font-weight:700;font-size:20px;letter-spacing:0.3px;color:#fff;box-sizing:border-box;}
  ...
  #canvas .card-body{padding:20px 20px 60px;display:flex;flex-direction:column;align-items:center;gap:12px;text-align:center;border-radius:0 0 14px 14px;background:var(--card-body-background,var(--card-body-gradient,var(--card-fill,#ffffff)));flex:1 1 auto;width:100%;box-sizing:border-box;line-height:1.3;border-top:1px solid var(--card-body-divider,var(--card-border-color,rgba(47,128,237,0.25)));}
  #canvas .card-row{display:flex;align-items:center;justify-content:center;gap:10px;text-align:center;flex-wrap:wrap;width:100%;line-height:1.25;} #canvas .card:not(.card--large):not(.card--gold) .card-body{padding-bottom:40px;gap:8px;} #canvas .card.card--large .card-body,#canvas .card.card--gold .card-body{justify-content:center;} #canvas .card:not(.card--large):not(.card--gold) .card-row{gap:8px;}
  #canvas .label{color:#6b7280;font-weight:500;font-size:14px;text-align:center;max-width:100%;word-break:break-word;overflow-wrap:anywhere;line-height:1.2;}
  #canvas .value{color:#111827;font-weight:600;font-size:15px;outline:none;padding:3px 6px;border-radius:6px;line-height:1.2;min-width:120px;text-align:center;}
