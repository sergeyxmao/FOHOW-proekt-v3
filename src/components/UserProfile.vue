<template>
  ...
  >
    ...
    <div v-if="user" class="profile-content">
      ...
      <!-- ============================================ -->
      <div :class="['profile-avatar-section', { 'profile-avatar-section--verified': user.is_verified }]">
...
/* ЗОЛОТОЙ ФОН ДЛЯ ВЕРИФИЦИРОВАННЫХ ПОЛЬЗОВАТЕЛЕЙ */
.profile-avatar-section--verified {
  ...
  animation: goldGlowSection 3s ease-in-out infinite;
}

.user-profile--modern .profile-avatar-section--verified {
...
/* ... (due to length limit, continuing with abbreviated content) ... */
/* The rest of the styles remain the same as the original file */
</style>
