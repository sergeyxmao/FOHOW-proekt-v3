export default {
  ...
  projectMenu: {
    ...
    tooltips: {
      ...
      exportSvg: 'Сохраняет доску в векторном формате (SVG) — идеально для печати на баннерах, постерах и в типографии. Масштабируется без потери качества',
      saveAsImage: 'Сохраняет доску как картинку — для печати или отправки в мессенджер',
  ...
  saveAsImage: {
    ...
    forPrint: 'Печать',
    forMessenger: 'Мессенджер',
    messengerHint: 'Оптимальный размер для отправки в Telegram, WhatsApp и другие чаты',
    format: 'Формат',
    orientation: 'Ориентация',
    portrait: 'Книжная',
    landscape: 'Альбомная',
    hideContent: 'Скрыть содержимое',
    blackAndWhite: 'Ч/Б (контур)',
    export: 'Сохранить',
    cancel: 'Отмена',
  ...
  userProfile: {
    ...
    scheduledPlanPending: 'Запланирован переход на тариф',
